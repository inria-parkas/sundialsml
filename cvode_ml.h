...
enum cvode_iter_tag {
  VARIANT_CVODE_ITER_TAG_NEWTON = 0,
  VARIANT_CVODE_ITER_TAG_FUNCTIONAL,
};
...
enum cvode_spils_params_index {
  RECORD_CVODE_SPILS_PARAMS_PRETYPE = 0,
  RECORD_CVODE_SPILS_PARAMS_MAXL,
};
...
enum cvode_linear_solver_tag {
  /* untagged: */
  VARIANT_CVODE_LINEAR_SOLVER_DIAG = 0,
  /* tagged: */
#if CVODE_ML_BIGARRAY
  VARIANT_CVODE_LINEAR_SOLVER_DENSE = 0,
  VARIANT_CVODE_LINEAR_SOLVER_LAPACKDENSE,
  VARIANT_CVODE_LINEAR_SOLVER_BAND,
