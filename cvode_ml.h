...
enum cvode_bandrange_tag {
  RECORD_BANDRANGE_MUPPER = 0,
  RECORD_BANDRANGE_MLOWER,
};

enum cvode_sprange_tag {
  RECORD_SPRANGE_PRETYPE = 0,
  RECORD_SPRANGE_MAXL,
};

enum linear_solver_tag {
  /* untagged: */
  VARIANT_LINEAR_SOLVER_DENSE          = 0,
  VARIANT_LINEAR_SOLVER_LAPACKDENSE,
  VARIANT_LINEAR_SOLVER_DIAG,
  /* tagged: */
  VARIANT_LINEAR_SOLVER_BAND           = 0,
  VARIANT_LINEAR_SOLVER_LAPACKBAND,
  VARIANT_LINEAR_SOLVER_SPGMR,
  VARIANT_LINEAR_SOLVER_SPBCG,
  VARIANT_LINEAR_SOLVER_SPTFQMR,
  VARIANT_LINEAR_SOLVER_BANDED_SPGMR,
  VARIANT_LINEAR_SOLVER_BANDED_SPBCG,
  VARIANT_LINEAR_SOLVER_BANDED_SPTFQMR,
};

enum cvode_solver_result_tag {
  VARIANT_SOLVER_RESULT_CONTINUE        = 0,
  VARIANT_SOLVER_RESULT_ROOTSFOUND,
  VARIANT_SOLVER_RESULT_STOPTIMEREACHED,
};

enum cvode_integrator_stats_index {
  RECORD_INTEGRATOR_STATS_STEPS		       = 0,
  RECORD_INTEGRATOR_STATS_RHS_EVALS,
  RECORD_INTEGRATOR_STATS_LINEAR_SOLVER_SETUPS,
  RECORD_INTEGRATOR_STATS_ERROR_TEST_FAILURES,
  RECORD_INTEGRATOR_STATS_LAST_INTERNAL_ORDER,
  RECORD_INTEGRATOR_STATS_NEXT_INTERNAL_ORDER,
  RECORD_INTEGRATOR_STATS_INITIAL_STEP_SIZE,
  RECORD_INTEGRATOR_STATS_LAST_STEP_SIZE,
  RECORD_INTEGRATOR_STATS_NEXT_STEP_SIZE,
  RECORD_INTEGRATOR_STATS_INTERNAL_TIME,
};

enum cvode_error_details_index {
  RECORD_ERROR_DETAILS_ERROR_CODE    = 0,
  RECORD_ERROR_DETAILS_MODULE_NAME,
  RECORD_ERROR_DETAILS_FUNCTION_NAME,
  RECORD_ERROR_DETAILS_ERROR_MESSAGE,
};

enum cvode_jacobian_arg_index {
  RECORD_JACOBIAN_ARG_JAC_T   = 0,
  RECORD_JACOBIAN_ARG_JAC_Y,
  RECORD_JACOBIAN_ARG_JAC_FY,
  RECORD_JACOBIAN_ARG_JAC_TMP,
};

enum cvode_spils_solve_arg_index {
  RECORD_SPILS_SOLVE_ARG_RHS   = 0,
  RECORD_SPILS_SOLVE_ARG_GAMMA,
  RECORD_SPILS_SOLVE_ARG_DELTA,
  RECORD_SPILS_SOLVE_ARG_LEFT,
};

enum cvode_precond_type_tag {
  VARIANT_PRECOND_TYPE_PRECNONE  = 0,
  VARIANT_PRECOND_TYPE_PRECLEFT,
  VARIANT_PRECOND_TYPE_PRECRIGHT,
  VARIANT_PRECOND_TYPE_PRECBOTH,
};

enum preconditioning_type_tag {
  VARIANT_PRECONDITIONING_TYPE_PRECNONE  = 0,
  VARIANT_PRECONDITIONING_TYPE_PRECLEFT,
  VARIANT_PRECONDITIONING_TYPE_PRECRIGHT,
  VARIANT_PRECONDITIONING_TYPE_PRECBOTH,
};
