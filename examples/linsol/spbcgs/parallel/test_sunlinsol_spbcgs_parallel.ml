 ...
 * --------------------------------------------------------------------*)
module SPBCGS_tests : (Test_linsol.LINSOL_TESTS
...
module Test = Test_linsol.Test (SPBCGS_tests) (Nvector_parallel.Ops)
...
type user_data = {
  ...
  s1     : RealArray.t;      (* scaling vectors supplied to SPBCGS *)
  s2     : RealArray.t;
...
let main () =
  ...
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module failed %d initialization tests@\n@\n" !fails;
    exit 1
  ...
  (* Print result *)
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module, problem 1, failed %d tests@\n@\n" !fails;
    passfail += 1
  end else if myid = 0 then
  ...
  (* Print result *)
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module, problem 2, failed %d tests@\n@\n" !fails;
    passfail += 1
  end else if myid = 0 then
  ...
  (* Print result *)
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module, problem 3, failed %d tests@\n@\n" !fails;
    passfail += 1
  end else if myid = 0 then
  ...
  (* Print result *)
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module, problem 4, failed %d tests@\n@\n" !fails;
    passfail += 1
  end else if myid = 0 then
  ...
  (* Print result *)
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module, problem 5, failed %d tests@\n@\n" !fails;
    passfail += 1
  end else if myid = 0 then
  ...
  (* Print result *)
  if !fails > 0 then begin
    printf "FAIL: SUNLinSol_SPBCGS module, problem 6, failed %d tests@\n@\n" !fails;
    passfail += 1
  end else if myid = 0 then
