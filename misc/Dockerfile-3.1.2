# docker build -t sundialsml-env:3.1.2 - <Dockerfile-3.1.2
# docker run -v $HOME/Projects/sundialsml:/home/opam/sundialsml -it sundialsml-env:3.1.2 bash
FROM ocaml/opam2
...
RUN git clone $SUNDIALS_GIT --branch $SUNDIALS_TAG --depth 1 $BUILDDIR/sundials\
 && wget -qO- $SUNDIALSML_SRC/misc/sundials-3.1.2.patch\
