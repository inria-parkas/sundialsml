# docker build -t sundialsml-env:4.0.2 - <Dockerfile-4.0.2
# docker run -v $HOME/Projects/sundialsml:/home/opam/sundialsml -it sundialsml-env:4.0.2 bash
FROM ocaml/opam2
...
RUN git clone $SUNDIALS_GIT --branch $SUNDIALS_TAG --depth 1 $BUILDDIR/sundials\
 && wget -qO- $SUNDIALSML_SRC/misc/sundials-4.0.2.patch\
