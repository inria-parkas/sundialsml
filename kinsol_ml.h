...
enum kinsol_index {
    ...
    RECORD_KINSOL_SESSION_LS_CLASS,
...
enum kinsol_alternate_callbacks_index {
  RECORD_KINSOL_ALTERNATE_CALLBACKS_LINIT = 0,
  RECORD_KINSOL_ALTERNATE_CALLBACKS_LSETUP,
  RECORD_KINSOL_ALTERNATE_CALLBACKS_LSOLVE,
  RECORD_KINSOL_ALTERNATE_CALLBACKS_SIZE
};

enum kinsol_bbd_callbacks_index {
  RECORD_KINSOL_BBD_CALLBACKS_LOCAL_FN = 0,
  RECORD_KINSOL_BBD_CALLBACKS_COMM_FN,
  RECORD_KINSOL_BBD_CALLBACKS_SIZE
};
