...
module Adjoint : sig (* {{{ *)
  ...
  module Dls : sig (* {{{ *)
    ...
    (** Create a Cvodes-specific linear solver from a generic dense linear
  ...
  (** Alternate Linear Solvers.
      ...
      @cvodes <node8#s:new_linsolv> Providing Alternate Linear Solver Modules *)
  module Alternate : sig (* {{{ *)
    ...
    (** Functions that initialize linear solver data, like counters and
        ...
        @cvodes <node8#SECTION00810000000000000000> linit *)
    ...
    (** Functions that prepare the linear solver for subsequent calls
        ...
        @cvodes <node8#SECTION00820000000000000000> lsetup *)
    ...
    val get_gammas : ('data, 'kind) bsession -> Cvode.Alternate.gammas
  end (* }}} *)
