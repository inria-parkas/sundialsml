...
enum cvodes_fwd_session_index {
    ...
    RECORD_CVODES_FWD_SESSION_CHECKQUADVEC,
    RECORD_CVODES_FWD_SESSION_HAS_QUAD,
    ...
    RECORD_CVODES_FWD_SESSION_FNLS_SOLVER,
...
#define CVODES_SENSRHSFN1_FROM_EXT(v)    Field((v), RECORD_CVODES_FWD_SESSION_SENSRHSFN1)
#define CVODES_QUADSENSRHSFN_FROM_EXT(v) Field((v), RECORD_CVODES_FWD_SESSION_QUADSENSRHSFN)
#define CVODES_QUADRHSFN_FROM_EXT(v)     Field((v), RECORD_CVODES_FWD_SESSION_QUADRHSFN)
...
enum cvodes_bwd_session_index {
    ...
    RECORD_CVODES_BWD_SESSION_CHECKBQUADVEC,
...
enum cvodes_bspils_precfns_index {
  RECORD_CVODES_BSPILS_PRECFNS_PREC_SOLVE_FN   = 0,
  RECORD_CVODES_BSPILS_PRECFNS_PREC_SETUP_FN,
  RECORD_CVODES_BSPILS_PRECFNS_SIZE
};

enum cvodes_bbbd_precfns_index {
  RECORD_CVODES_BBBD_PRECFNS_LOCAL_FN = 0,
  RECORD_CVODES_BBBD_PRECFNS_COMM_FN,
  RECORD_CVODES_BBBD_PRECFNS_SIZE
};

enum cvodes_sens_method_tag {
    VARIANT_CVODES_SENS_METHOD_SIMULTANEOUS = 0,    // constructors with arguments
...
enum cvodes_sens_stats_index {
    RECORD_CVODES_SENS_STATS_NUM_SENS_EVALS = 0,
    RECORD_CVODES_SENS_STATS_NUM_RHS_EVALS,
    RECORD_CVODES_SENS_STATS_NUM_ERR_TEST_FAILS,
    RECORD_CVODES_SENS_STATS_NUM_LIN_SOLV_SETUPS,
    RECORD_CVODES_SENS_STATS_SIZE
};

enum cvodes_sensrhsfn_args_index {
    RECORD_CVODES_SENSRHSFN_ARGS_T = 0,
    RECORD_CVODES_SENSRHSFN_ARGS_Y,
    RECORD_CVODES_SENSRHSFN_ARGS_YP,
    RECORD_CVODES_SENSRHSFN_ARGS_TMP,
    RECORD_CVODES_SENSRHSFN_ARGS_SIZE
};

enum cvodes_quadsensrhsfn_args_index {
    RECORD_CVODES_QUADSENSRHSFN_ARGS_T = 0,
    RECORD_CVODES_QUADSENSRHSFN_ARGS_Y,
    RECORD_CVODES_QUADSENSRHSFN_ARGS_SENS,
    RECORD_CVODES_QUADSENSRHSFN_ARGS_YQP,
    RECORD_CVODES_QUADSENSRHSFN_ARGS_TMP,
    RECORD_CVODES_QUADSENSRHSFN_ARGS_SIZE
};
...
enum cvodes_adj_brhsfn_args_index {
    RECORD_CVODES_ADJ_BRHSFN_ARGS_T = 0,
    RECORD_CVODES_ADJ_BRHSFN_ARGS_Y,
    RECORD_CVODES_ADJ_BRHSFN_ARGS_YB,
    RECORD_CVODES_ADJ_BRHSFN_ARGS_SIZE
};

enum cvodes_adj_bquadrhsfn_args_index {
    RECORD_CVODES_ADJ_BQUADRHSFN_ARGS_T = 0,
    RECORD_CVODES_ADJ_BQUADRHSFN_ARGS_Y,
    RECORD_CVODES_ADJ_BQUADRHSFN_ARGS_YB,
    RECORD_CVODES_ADJ_BQUADRHSFN_ARGS_SIZE
};

enum cvodes_nonlin_system_data_index {
  RECORD_CVODES_NONLIN_SYSTEM_DATA_TN = 0,
  RECORD_CVODES_NONLIN_SYSTEM_DATA_YSPRED,
  RECORD_CVODES_NONLIN_SYSTEM_DATA_YSN,
  RECORD_CVODES_NONLIN_SYSTEM_DATA_GAMMA,
  RECORD_CVODES_NONLIN_SYSTEM_DATA_RLS1,
  RECORD_CVODES_NONLIN_SYSTEM_DATA_ZNS1,
  RECORD_CVODES_NONLIN_SYSTEM_DATA_SIZE
};
