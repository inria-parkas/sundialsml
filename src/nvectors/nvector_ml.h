...
enum nvector_ops_tag {
  ...
  NVECTOR_OPS_NVDOTPRODMULTI_LOCAL,
  NVECTOR_OPS_NVDOTPRODMULTI_ALLREDUCE,
...
enum nvector_id_tag {
  ...
  VARIANT_NVECTOR_ID_TAG_HIP,
  VARIANT_NVECTOR_ID_TAG_SYCL,
  VARIANT_NVECTOR_ID_TAG_RAJA,
  VARIANT_NVECTOR_ID_TAG_KOKKOS,
