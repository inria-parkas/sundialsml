...
enum arkode_session_index {
    ...
    RECORD_ARKODE_SESSION_RELAX_FN,
    RECORD_ARKODE_SESSION_RELAX_JAC_FN,
...
enum arkode_relax_solver_tag {
  VARIANT_ARKODE_RELAX_SOLVER_BRENT = 0,
  VARIANT_ARKODE_RELAX_SOLVER_NEWTON = 1,
};
...
enum arkode_mri_coupling_table_tag {
  ...
  VARIANT_ARKODE_MRI_COUPLING_GARK_ForwardEuler,
  VARIANT_ARKODE_MRI_COUPLING_GARK_Ralston2,
  VARIANT_ARKODE_MRI_COUPLING_GARK_ERK22a,
  VARIANT_ARKODE_MRI_COUPLING_GARK_ERK22b,
  VARIANT_ARKODE_MRI_COUPLING_GARK_Ralston3,
  VARIANT_ARKODE_MRI_COUPLING_GARK_BackwardEuler,
  VARIANT_ARKODE_MRI_COUPLING_GARK_ImplicitMidpoint,
  VARIANT_ARKODE_MRI_COUPLING_IMEX_GARK_Euler,
  VARIANT_ARKODE_MRI_COUPLING_IMEX_GARK_Trapezoidal,
  VARIANT_ARKODE_MRI_COUPLING_IMEX_GARK_Midpoint,
};
...
enum arkode_exn_index {
    ...
    ARKODE_EXN_PostprocStageFailure,
    ARKODE_EXN_UserPredictFailure,
    ARKODE_EXN_InvalidTable,
    ARKODE_EXN_BadK,
    ARKODE_EXN_BadT,
    ARKODE_EXN_VectorOpErr,
    ARKODE_EXN_RelaxationFailure,
    ARKODE_EXN_NoRelaxation,
    ARKODE_EXN_RelaxationFuncFailure,
    ARKODE_EXN_RelaxationJacFuncFailure,
    ARKODE_EXN_SET_SIZE
};
