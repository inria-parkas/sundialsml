...
enum lsolver_linear_solver_id_tag {
    VARIANT_LSOLVER_ID_BAND = 0,
    VARIANT_LSOLVER_ID_DENSE,
    VARIANT_LSOLVER_ID_KLU,
    VARIANT_LSOLVER_ID_LAPACKBAND,
    VARIANT_LSOLVER_ID_LAPACKDENSE,
    VARIANT_LSOLVER_ID_PCG,
    VARIANT_LSOLVER_ID_SPBCGS,
    VARIANT_LSOLVER_ID_SPFGMR,
    VARIANT_LSOLVER_ID_SPGMR,
    VARIANT_LSOLVER_ID_SPTFQMR,
    VARIANT_LSOLVER_ID_SUPERLUDIST,
    VARIANT_LSOLVER_ID_SUPERLUMT,
    VARIANT_LSOLVER_ID_CUSOLVERSP_BATCHQR,
    VARIANT_LSOLVER_ID_MAGMADENSE,
    VARIANT_LSOLVER_ID_ONEMKLDENSE,
    VARIANT_LSOLVER_ID_GINKGO,
    VARIANT_LSOLVER_ID_KOKKOS,
    VARIANT_LSOLVER_ID_CUSTOM,
};
