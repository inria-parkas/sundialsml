...
enum ida_alternate_lsetup_args_index {
    RECORD_IDA_ALTERNATE_LSETUP_ARGS_Y = 0,
    RECORD_IDA_ALTERNATE_LSETUP_ARGS_YP,
    RECORD_IDA_ALTERNATE_LSETUP_ARGS_RES,
    RECORD_IDA_ALTERNATE_LSETUP_ARGS_TMP,
    RECORD_IDA_ALTERNATE_LSETUP_ARGS_SIZE
};

enum ida_alternate_lsolve_args_index {
    RECORD_IDA_ALTERNATE_LSOLVE_ARGS_EWT = 0,
    RECORD_IDA_ALTERNATE_LSOLVE_ARGS_Y,
    RECORD_IDA_ALTERNATE_LSOLVE_ARGS_YP,
    RECORD_IDA_ALTERNATE_LSOLVE_ARGS_RES,
