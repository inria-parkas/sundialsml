...
enum arkode_spils_callbacks_index {
  RECORD_ARKODE_SPILS_CALLBACKS_PREC_SOLVE_FN = 0,
  RECORD_ARKODE_SPILS_CALLBACKS_PREC_SETUP_FN,
  RECORD_ARKODE_SPILS_CALLBACKS_JAC_TIMES_VEC_FN,
  RECORD_ARKODE_SPILS_CALLBACKS_SIZE
};

enum arkode_spils_mass_callbacks_index {
  RECORD_ARKODE_SPILS_MASS_CALLBACKS_PREC_SOLVE_FN = 0,
  RECORD_ARKODE_SPILS_MASS_CALLBACKS_PREC_SETUP_FN,
  RECORD_ARKODE_SPILS_MASS_CALLBACKS_TIMES_VEC_FN,
  RECORD_ARKODE_SPILS_MASS_CALLBACKS_SIZE
};
...
enum arkode_alternate_lsolve_args_index {
    RECORD_ARKODE_ALTERNATE_LSOLVE_ARGS_EWT = 0,
    RECORD_ARKODE_ALTERNATE_LSOLVE_ARGS_Y,
    RECORD_ARKODE_ALTERNATE_LSOLVE_ARGS_RHS,
    RECORD_ARKODE_ALTERNATE_LSOLVE_ARGS_SIZE
};

enum arkode_bbd_callbacks_index {
  RECORD_ARKODE_BBD_CALLBACKS_LOCAL_FN = 0,
  RECORD_ARKODE_BBD_CALLBACKS_COMM_FN,
  RECORD_ARKODE_BBD_CALLBACKS_SIZE
};
...
enum arkode_spils_mass_solve_arg_index {
  ...
  RECORD_ARKODE_SPILS_MASS_SOLVE_ARG_TMP,
...
enum arkode_rk_method_index {
  ...
  RECORD_ARKODE_RK_METHOD_STAGE_TIMES,
  RECORD_ARKODE_RK_METHOD_COEFFICIENTS,
  RECORD_ARKODE_RK_METHOD_BEMBED,
...
#define ARKODE_EXN(name) (Field(Field (Field (sundials_ml_exn_table,	\
					     ARKODE_EXN_SET),		\
				      ARKODE_EXN_ ## name),		\
			       0))
