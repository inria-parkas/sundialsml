...
enum cvodes_fwd_session_index {
    ...
    RECORD_CVODES_FWD_SESSION_CHECKQUADSENSVEC,
...
enum cvodes_bspils_callbacks_index {
  RECORD_CVODES_BSPILS_CALLBACKS_PREC_SOLVE_FN   = 0,
  RECORD_CVODES_BSPILS_CALLBACKS_PREC_SETUP_FN,
  RECORD_CVODES_BSPILS_CALLBACKS_JAC_TIMES_VEC_FN,
  RECORD_CVODES_BSPILS_CALLBACKS_SIZE
};

enum cvodes_bbbd_callbacks_index {
  RECORD_CVODES_BBBD_CALLBACKS_LOCAL_FN = 0,
  RECORD_CVODES_BBBD_CALLBACKS_COMM_FN,
  RECORD_CVODES_BBBD_CALLBACKS_SIZE
};
